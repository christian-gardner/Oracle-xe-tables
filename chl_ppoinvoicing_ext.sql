DROP TABLE CHL_PPOINVOICING_EXT CASCADE CONSTRAINTS;

CREATE TABLE CHL_PPOINVOICING_EXT
(
...
ORGANIZATION EXTERNAL
  (  TYPE ORACLE_LOADER
     DEFAULT DIRECTORY LOAD_CHL_PPOINVOICING_DIR
     ACCESS PARAMETERS 
       ( RECORDS DELIMITED by  '\n'
            BADFILE  LOAD_SGP_PPOINVOICING: 'CHL_PPOINVOICING.bad'
            LOGFILE  LOAD_SGP_PPOINVOICING: 'CHL_PPOINVOICING.log'
  ...
  (
     ...
     LOCATION (LOAD_CHL_PPOINVOICING_DIR:'SGP_PPOINVOICING_02072017160007.txt')
  )
