DROP TABLE CHL_FEES_EXT CASCADE CONSTRAINTS;

CREATE TABLE CHL_FEES_EXT
(
...
ORGANIZATION EXTERNAL
  (  TYPE ORACLE_LOADER
     DEFAULT DIRECTORY LOAD_CHL_FEES_DIR
     ACCESS PARAMETERS 
  ...
  (
     ...
     LOCATION (LOAD_CHL_FEES_DIR:'SGP_FEES_02072017094936.txt')
  )
